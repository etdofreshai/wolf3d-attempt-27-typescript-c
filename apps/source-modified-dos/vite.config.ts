...
export default defineConfig({
  ...
  plugins: [sourceModifiedDosPlugin()]
});

function sourceModifiedDosPlugin(): Plugin {
  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use(async (request, response, next) => {
        ...
        if (requestUrl === "/__source-modified-dos/status") {
        ...
        if (requestUrl.startsWith("/__source-modified-dos/asset/")) {
          const fileName = decodeURIComponent(requestUrl.replace("/__source-modified-dos/asset/", "")).toUpperCase();
        ...
        if (requestUrl.startsWith("/__source-modified-dos/toolchain/")) {
          const toolchain = await detectToolchain(privateToolchainRoot);
          ...
          const relativePath = decodeURIComponent(requestUrl.replace("/__source-modified-dos/toolchain/", ""));
        ...
        if (requestUrl.startsWith("/__source-modified-dos/source/")) {
          const relativePath = decodeURIComponent(requestUrl.replace("/__source-modified-dos/source/", ""));
