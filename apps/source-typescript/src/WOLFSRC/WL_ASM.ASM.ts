...
// Original file: source/WOLFSRC/WL_ASM.ASM
...
export const WOLFSRC_FILE = "WL_ASM.ASM";
export const WOLFSRC_FUNCTIONS = ["CheckIs386", "jabhack2"] as const;

export let ldivPatchApplied = false;

export function CheckIs386(): 1 {
  return 1;
}

export function jabhack2(): { readonly ldivPatchApplied: true } {
  ldivPatchApplied = true;
  return { ldivPatchApplied };
}
