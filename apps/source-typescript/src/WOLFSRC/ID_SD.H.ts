...
// Original file: source/WOLFSRC/ID_SD.H
...
export const WOLFSRC_FILE = "ID_SD.H";
export const WOLFSRC_FUNCTIONS = [] as const;

export const TickBase = 70;

export const sdm_Off = 0;
export const sdm_PC = 1;
export const sdm_AdLib = 2;
export type SDMode = typeof sdm_Off | typeof sdm_PC | typeof sdm_AdLib;

export const smm_Off = 0;
export const smm_AdLib = 1;
export type SMMode = typeof smm_Off | typeof smm_AdLib;

export const sds_Off = 0;
export const sds_PC = 1;
export const sds_SoundSource = 2;
export const sds_SoundBlaster = 3;
export type SDSMode =
  | typeof sds_Off
  | typeof sds_PC
  | typeof sds_SoundSource
  | typeof sds_SoundBlaster;
