...
// Original file: source/WOLFSRC/ID_US_A.ASM
...
export const WOLFSRC_FILE = "ID_US_A.ASM";
export const WOLFSRC_FUNCTIONS = ["US_InitRndT", "US_RndT"] as const;
...
export let rndindex = 0;

export function US_InitRndT(randomize: boolean, timeLowByte = 0): void {
  if (!randomize) {
    rndindex = 0;
    return;
  }
  rndindex = timeLowByte & 0xff;
}
