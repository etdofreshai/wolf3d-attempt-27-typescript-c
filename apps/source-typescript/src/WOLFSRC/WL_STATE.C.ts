...
import {
  ...
  type SpawnNewObjSummary,
  type TryWalkSummary,
  type ActorDamageSummary,
  type DropItemSummary,
  type KillActorSummary,
} from "./TS_LEVEL_SETUP";

// @generated-from-wolfsrc
// Original file: source/WOLFSRC/WL_STATE.C
...
export const WOLFSRC_FILE = "WL_STATE.C";
...
export function CheckSight(
  ...
  return CheckSightMemory(dgroup, actor, options);
}
...
export function DamageActor(
  ...
  return DamageActorMemory(dgroup, actor, damage);
}
...
export function DropItem(
  ...
  return DropItemMemory(dgroup, itemType, tilex, tiley);
}

export function FirstSighting(dgroup: DOSMemory, actor: number): void {
  return FirstSightingMemory(dgroup, actor);
}

export function KillActor(dgroup: DOSMemory, actor: number): KillActorSummary {
  return KillActorMemory(dgroup, actor);
}

export function MoveObj(
  dgroup: DOSMemory,
  actor: number,
  move: number,
  options: { readonly tics?: number } = {},
): void {
  return MoveObjMemory(dgroup, actor, move, options);
}

export function NewState(dgroup: DOSMemory, actor: number, state: string): void {
  return NewStateMemory(dgroup, actor, state);
}

export function SelectChaseDir(dgroup: DOSMemory, plane0: Uint16Array, actor: number): void {
  return SelectChaseDirMemory(dgroup, plane0, actor);
}

export function SelectDodgeDir(dgroup: DOSMemory, plane0: Uint16Array, actor: number): void {
  return SelectDodgeDirMemory(dgroup, plane0, actor);
}

export function SelectRunDir(dgroup: DOSMemory, plane0: Uint16Array, actor: number): void {
  return SelectRunDirMemory(dgroup, plane0, actor);
}

export function SightPlayer(
  dgroup: DOSMemory,
  actor: number,
  options: SightPlayerOptions = {},
): boolean {
...
export function SpawnNewObj(
  ...
  return SpawnNewObjMemory(dgroup, plane0, tilex, tiley, state);
}

export function TryWalk(dgroup: DOSMemory, plane0: Uint16Array, actor: number): TryWalkSummary {
  return TryWalkMemory(dgroup, plane0, actor);
}
// ---------------------------------------------------------------------------
