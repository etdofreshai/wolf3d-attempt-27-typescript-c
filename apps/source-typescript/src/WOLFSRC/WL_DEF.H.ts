...
// Original file: source/WOLFSRC/WL_DEF.H
...
export const WOLFSRC_FILE = "WL_DEF.H";
export const WOLFSRC_FUNCTIONS = [] as const;

export const SPR_DEMO = 0;
export const SPR_DEATHCAM = 1;
export const SPR_KNIFEREADY = 416;
export const SPR_PISTOLREADY = 421;
export const SPR_MACHINEGUNREADY = 426;
export const SPR_CHAINREADY = 431;
